...
\begin{tabular}{c|p{5cm}}
	...
	\raisebox{-1pt}{\includegraphics[height=0.3cm]{./images/scholar.png}}
		& \href{https://scholar.google.com/citations?user=CYG8yj4AAAAJ&hl=en&oi=ao}{Google Scholar page} \\
	\raisebox{-0.1cm}{\includegraphics[height=0.35cm]{./images/github.png}}
...
\begin{tabular}{c|p{5cm}}
	\raisebox{-4pt}{\textifsymbol{18}}
		...
		35000 Rennes\\
	\raisebox{-0.7pt}{\includegraphics[height=0.3cm]{./images/bday.png}}
		& 28 septembre 1993\\
	\raisebox{-0.5pt}{\includegraphics[height=0.3cm]{./images/car.png}}
		& Driving license\\
\end{tabular}
% \flushright \includegraphics[scale=0.4]{./images/moi.jpg}
\end{minipage}
\vskip0.4cm
...
\begin{longtable}{@{}C{\colone}p{\coltwo}@{}}
	Sep 2025 -- present \par
		\vskip0.5cm \includegraphics[height=0.8cm]{./images/inria.jpg}
...
\\
	2020 -- present \par
		\vskip0.3cm \includegraphics[height=1cm]{./images/ens.png} \par
		\vskip0.2cm \includegraphics[height=0.8cm]{./images/ntnu.pdf} \par
		\vskip0.1cm \includegraphics[height=0.5cm]{./images/n7.png}
...
\\
% 	Jul 2025 -- Aug 2025
% 	& {Relocation to France, waiting for INRIA contract to start (unemployed)}
% \\
	Feb 2023 -- Jun 2025 \par
		\vskip0.6cm \includegraphics[height=1cm]{./images/ntnu.pdf}
...
% \\
	Jan 2019 -- Oct 2022 \par
		\vskip0.6cm \includegraphics[height=0.9cm]{./images/laas.png}
...
% \\
	Mar 2017 -- Jun 2018 \par
		\vskip0.4cm \includegraphics[height=0.9cm]{./images/laas.png}
...
% \\
  	Summer 2016 \par
  		\vskip0.4cm \includegraphics[height=0.5cm]{./images/atos.jpg}
...
\\
	Summer 2015 \par
		\vskip0.4cm \includegraphics[height=1cm]{./images/irit.png}
...
\\
	2013 -- 2016 \par
		\vskip0.5cm \includegraphics[height=0.6cm]{./images/n7.png} \par
		\vskip0.2cm \includegraphics[height=0.6cm]{./images/polymtl.jpg} \par
...
% \end{longtable} \par
\notes{Citation count and data as of 16/02/2026 \par
	Total citations: 161 \par
	h-index: 6 \par
}
\subsection{Journal Publications}
\begin{longtable}{@{}p{\colone}p{\coltwo}@{}}
	\href{https://www.scimagojr.com/journalsearch.php?q=18050&tip=sid}{IJRR}, 2025 \cited{0}
...
\\
	\href{https://www.scimagojr.com/journalsearch.php?q=21100900379&tip=sid}{RAL}, 2022 \cited{19}
...
\\
	\href{https://www.scimagojr.com/journalsearch.php?q=21100900379&tip=sid}{RAL}, 2021 \cited{36}
	& \me, A. Franchi, \href{https://doi.org/10.1109/LRA.2020.3045654}{\itshape Motor and Perception Constrained NMPC for Torque-Controlled Generic Aerial Vehicles} \par
		-- {\bfseries Finalist for Best Paper Award} in Unmanned Aerial Vehicles at ICRA'21
\end{longtable}
\notes{
...
\begin{longtable}{@{}p{\colone}p{\coltwo}@{}}
	\bfseries \href{https://ntnu-arl.github.io/unified_autonomy_stack/}{Autonomy Stack}
		& Comprehensive Unified Autonomy Stack for Robots -- { Developer}
\\
	\bfseries \href{https://ntnu-arl.github.io/sdf-nmpc/}{SDF-NMPC}
		& Neural NMPC for collision avoidance -- {\small Main developer, First author of associated paper}
\\
	\bfseries \href{https://github.com/ntnu-arl/composite_cbf}{CCBF}
		& Composite CBF for collision avoidance -- {\small Main developer, author of associated paper}
\\
	\bfseries \href{https://github.com/ntnu-arl/PX4-CBF}{PX4-CBF}
		& Embedded integration of CCBF in the \href{https://px4.io/}{PX4 Autopilot} -- {\small Developer, author of associated paper}
\end{longtable}
